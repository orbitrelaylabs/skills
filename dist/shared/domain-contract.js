...
export const skillResultStatuses = ['success', 'partial', 'insufficient_data', 'failed'];
...
export function createSkillResultSchema(extension) {
    return z
...
//# sourceMappingURL=domain-contract.js.map