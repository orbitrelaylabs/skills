import { z } from 'zod';
import { evmChainIdSchema, transactionAnalysisResultSchema, } from '../transaction-analysis/index.js';
...
export const publicChainNetworkSchema = z
    ...
    .min(2)
    .max(96)
    .refine((value) => normalizePublicNetworkIdentifier(value) !== undefined, 'Expected a supported network alias or canonical network id.');
...
export function createPublicTransactionClientStub(getTransaction) {
    return {
        close: () => Promise.resolve(),
        getTransaction,
    };
}
//# sourceMappingURL=public-transaction-contracts.js.map